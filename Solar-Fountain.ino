...
// const char* password = "32548AE9ZQ234RS42";
...
"<script>"
    "function check(form)"
    "{"
    "if(form.userid.value=='tricor' && form.pwd.value=='flobertfluxus1!')"
    "{"
...
if (myString == "Tgszeit")
  ...
  if (Zeit < 9) (Zeit = 9);
  if (Zeit > 19) (Zeit = 19);
  Tgszeita = (-18 * Zeit) + 342;
  Serial.print("Tgszeita: ");
  Serial.println(Tgszeita);
  }
}
